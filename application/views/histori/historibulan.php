...
$this->fpdf->Ln(2);
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(19,1,"Laporan Riwayat Pasien $namapasien ",0,0,'C');


/* setting header table */
$this->fpdf->Ln(1);
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(4  , 1, 'Tanggal Histori'           , 1, 'LR', 'L');
$this->fpdf->Cell(5  , 1, 'Nama Layanan'           , 1, 'LR', 'L');
$this->fpdf->Cell(4  , 1, 'Resep'           , 1, 'LR', 'L');
$this->fpdf->Cell(6  , 1, 'Catatan'           , 1, 'LR', 'L');
...
foreach($records as $riwayat)
{
    ...
    $this->fpdf->Cell(4  , 0.7, $riwayat["tanggal_histori"]  , 1, 'LR', 'L');
    $this->fpdf->Cell(5  , 0.7,  $riwayat["nama_layanan"]  , 1, 'LR', 'L');
    $this->fpdf->Cell(4  , 0.7,  $riwayat["resep"]  , 1, 'LR', 'L');
    $this->fpdf->Cell(6  , 0.7,  $riwayat["catatan"]  , 1, 'LR', 'L');
