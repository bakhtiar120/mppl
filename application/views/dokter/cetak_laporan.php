...
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Ln(1);
$this->fpdf->Cell(19,1,'LAPORAN DATA DOKTER',0,0,'C');
...
$this->fpdf->Cell(4  , 1, 'Nama Dokter'           , 1, 'LR', 'L');
$this->fpdf->Cell(8 , 1, 'Alamat Dokter' , 1, 'LR', 'L');
$this->fpdf->Cell(6 , 1, 'Telp Dokter' , 1, 'LR', 'L');
$no=1;
...
foreach($records as $dokter)
{
    ...
    $this->fpdf->Cell(4  , 0.7,  $dokter["nama_dokter"]  , 1, 'LR', 'L');
    $this->fpdf->Cell(8, 0.7,  $dokter["alamat_dokter"]  , 1, 'LR', 'L');
    $this->fpdf->Cell(6 , 0.7,  $dokter["telp_dokter"]  , 1, 'LR', 'L');
    $no++;
}
